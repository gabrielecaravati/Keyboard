...
; (function (factory) {
    ...
    var $keyboard = $.keyboard = function (el, options) {
        ...
        base.reveal = function (redraw) {
            ...
            //attach a modal panel to focus input with keyboard
            if (o.modalPanel.isActive) {
                var modalDiv = $(o.modalPanel.html);
                modalDiv.css("z-index", o.modalPanel.zIndex);
                modalDiv.css("opacity", o.modalPanel.panelOpacity);
                modalDiv.addClass(o.modalPanel.cssClass);
                //modalDiv.attr("tabindex", 9999);
                modalDiv.click(function (event) {
                    event.stopPropagation();
                    event.preventDefault();
                });

                modalClosureEvent = "virtual-keyboard:close-modal_" + Math.floor(Math.random() * 1000000);

                modalDiv.on(modalClosureEvent, function () {
                    //var modalPanel = $("." + o.modalPanel.cssClass);
                    var modalPanel = $(this);
                    if (modalPanel) {
                        modalPanel.remove();
                    }
                ...
                base.$el.attr("data-vki-input-z-index", base.$el.css("z-index"));
                base.$el.attr("data-vki-input-position", base.$el.css("position"));
                base.$el.css("z-index", o.modalPanel.zIndex + 1);
                base.$el.css("position", "relative");
                base.$el.parent().append(modalDiv);
            }
            ...
            if ($.ui && $.ui.position && base.position) {
                ...
                base.position.collision = base.position.collision || 'flipfit flip';
        ...
        base.close = function (accepted) {
            ...
            if (o.modalPanel.isActive) {
                base.$el.css("position", base.$el.attr("data-vki-input-position"));
                base.$el.css("z-index", base.$el.attr("data-vki-input-z-index"));

                var modalPanel = $("." + o.modalPanel.cssClass);
                setTimeout(function () {
                    modalPanel.trigger(modalClosureEvent);
                });
            }
    ...
    $keyboard.defaultOptions = {
        ...
        */
        ...
        modalPanel: {
            isActive: false,
            html: "<div style='background: black;z-index: 3300;position: fixed;left: 0;right: 0;top: 0;bottom: 0;'></div>",
            zIndex: 3300,
            cssClass: "virtual-keyboard-modal-panel",
            panelOpacity: 0.35
        }
